...
public partial class QuitSmokingAppDBContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BadgeId).HasName("PK__badges__E7989656B273100E");

            entity.ToTable("badges");

            entity.HasIndex(e => e.Code, "UQ__badges__357D4CF96E9FFFDE").IsUnique();
        ...
        {
            entity.HasKey(e => e.MessageId).HasName("PK__chat_mes__0BBF6EE62523A72E");
        ...
        {
            entity.HasKey(e => e.FeedbackId).HasName("PK__feedback__7A6B2B8C6073AFD5");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__forum_co__E7957687CA8DADF4");
        ...
        {
            entity.HasKey(e => e.PostId).HasName("PK__forum_po__3ED78766551F8476");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__notifica__E059842F8686BD75");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__payments__ED1FC9EA571B1672");
        ...
        {
            entity.HasKey(e => e.ProgressId).HasName("PK__progress__49B3D8C1F1D91022");
        ...
        {
            entity.HasKey(e => e.PlanId).HasName("PK__quit_pla__BE9F8F1DD068B300");
        ...
        {
            entity.HasKey(e => e.RecordId).HasName("PK__smoking___BFCFB4DDAD87BCAA");
        ...
        {
            entity.HasKey(e => e.SubscriptionId).HasName("PK__subscrip__863A7EC1D323F877");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__users__B9BE370FC9C20209");
        ...
        {
            entity.HasKey(e => e.UserBadgeId).HasName("PK__user_bad__225DFD72BFFAEBC3");
